...
**At the start of every new session, IMMEDIATELY run `/prime` before doing anything else.** Do not wait for the user to ask. Read all context files, provide the prime summary, and confirm readiness. This is mandatory and non-negotiable.
